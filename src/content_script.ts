  ...
  async render(text) {
    ...
    const tpl = `
      <div style="position: fixed;background-color: rgba(0, 0, 0, 0.3);width: 100%;height: 100%;top: 0;left: 0;z-index: 1000000002;display: flex;align-items: center;justify-content: center;">
        <div style="border-radius: 4px;padding:32px;background: white;box-shadow: rgba(0, 0, 0, 0.15) 2px 2px 5px;position: relative;">
          <div class="____qrcode_pro_close_btn____" style="cursor: pointer;transform: scale(1.2);color: #999;width: 20px;height: 20px;text-align: center;right: 5px;top: 5px;position: absolute;font-size: 24px;line-height: 20px;">×</div>
          <div>
